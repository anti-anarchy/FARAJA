...
export default function RespondersPage() {
	...
	const PRIORITY_COLOR = { Critical: "var(--sev-critical)", Medium: "var(--sev-medium)", Low: "var(--sev-low)" };
	const PRIORITY_SOFT = { Critical: "var(--sev-critical-soft)", Medium: "var(--sev-medium-soft)", Low: "var(--sev-low-soft)" };
					...
					<Paper withBorder radius="md" p="md">
						<Group justify="space-between" mb="xs">
							...
							<Badge
								styles={{
									root: {
										background: totalWeight > 100 ? "var(--sev-critical-soft)" : "var(--sev-low-soft)",
										color: totalWeight > 100 ? "var(--sev-critical)" : "var(--sev-low)",
									},
								}}
							>
						...
						<Stack gap="md">
							...
							<div>
								...
								<Alert
									...
									styles={{
										root: { background: "var(--sev-medium-soft)" },
										message: { color: "var(--ink-2)" },
										icon: { color: "var(--sev-medium)" },
									}}
								>
							...
							{weightNotification && (
								<Alert title="Saved" color="green">{weightNotification}</Alert>
							)}
						</Stack>
					</Paper>
						...
						<Stack gap="md">
								...
								{loadingZone ? (
									...
									<Stack gap="xs">
										<div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
											...
											<Badge style={{ backgroundColor: DAMAGE_COLORS[zoneData.properties.tier], color: "#fff" }}>
										...
										<div style={{ display: "flex", gap: 20 }}>
											...
											<div>
												...
												<Text fw={600} size="sm" style={{ color: "var(--sev-critical)" }}>
							...
							{pointData && (
								<Paper withBorder radius="md" p="md">
									...
									<Group gap="xs" mb={6}>
										<Badge size="sm" style={{ backgroundColor: DAMAGE_COLORS[pointData.properties.damage_level], color: "#fff" }}>
							...
							<Paper withBorder radius="md" p="md">
								...
								>
									...
									<Badge
										size="sm"
										style={{ background: PRIORITY_COLOR[computedPriority], color: "#fff" }}
									>
										{computedPriority}
									</Badge>
								</div>
								...
								{notification && (
									<Alert title="Success" color="green" mt="md">{notification}</Alert>
								)}
							</Paper>
						</Stack>
					)}
